...
CLUSTER_RULES = [
    ...
    ("Practical All-Rounder",{"efficiency": 5.0, "space": 5.0, "driver_comfort": 5.0,"passenger_comfort": 5.0}),
    ("Urban Agility",       {"efficiency": 7.0, "driver_comfort": 6.0}),
    ("Urban Agility",       {"price": 7.0, "tech": 6.0}),        # longgarkan tech
    ("High-End Performance",{"power": 8.0, "handling": 7.0}),
]
