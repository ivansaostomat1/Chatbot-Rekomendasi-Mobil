...
Jika kamu pengguna Windows, kamu tidak perlu membuka terminal satu per satu. Cukup klik ganda file berikut di folder utama, atau jalankan perintah ini di CMD/Terminal:
```bash
run_all.bat
```
